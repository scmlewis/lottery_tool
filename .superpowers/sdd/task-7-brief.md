# Task 7: Number View Component

**Files:**
- Create: `src/components/NumberView.tsx`
- Modify: None

**Interfaces:**
- Consumes: NumberBatchEntry, ActivityEntry, hooks
- Produces: Number drawing view with parameters and history

- [ ] **Step 1: Create src/components/NumberView.tsx**
...
```bash
git add src/components/NumberView.tsx
git commit -m "feat: add Number view component with draw animation"
```